...
var TZWebGLShader = (function () {
    ...
    TZWebGLShader.create = function (gd, params, onload) {
        ...
        function createTechniqueLoader(techniqueName) {
            return function () {
                shaderTechniques[techniqueName] = WebGLTechnique.create(gd, shader, techniqueName, techniques[techniqueName]);
...
var WebGLGraphicsDevice = (function () {
    ...
    WebGLGraphicsDevice.prototype.setParametersArrayCaching = function (parameters, techniqueParametersArray, numTechniqueParameters) {
        var gl = this.gl;
        var n;
    ...
    // ONLY USE FOR SINGLE PASS TECHNIQUES ON DRAWARRAY
    WebGLGraphicsDevice.prototype.setTechniqueCaching = function (technique, drawArrayId) {
